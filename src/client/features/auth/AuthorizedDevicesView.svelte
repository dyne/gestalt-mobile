...
<style>
  .devices{max-inline-size:48rem;margin:auto;padding:1rem;color:var(--theme-text)}.devices header{display:flex;gap:1rem;align-items:center}.devices h1,.devices h2{font-family:var(--theme-font-display)}.devices ul{padding:0;list-style:none}.devices li,section{margin-block:1rem;padding:1rem;background:var(--theme-surface);border:1px solid var(--theme-border);border-radius:var(--theme-radius);box-shadow:0 .25rem .75rem var(--theme-shadow)}.devices form{display:grid;gap:.65rem}.devices p{margin:0;overflow-wrap:anywhere}.devices input,.devices textarea,.devices button{min-block-size:44px;font:inherit}.devices input,.devices textarea{min-inline-size:0;padding:.45rem}.devices textarea{inline-size:100%;box-sizing:border-box;overflow-wrap:anywhere;resize:vertical;font-family:var(--theme-font-code)}.devices .actions{display:flex;gap:.5rem;flex-wrap:wrap}.devices .actions button{flex:1 1 11rem}.devices img{display:block;inline-size:12rem;max-inline-size:100%;margin-block:.75rem;background:var(--theme-canvas);padding:.5rem}.feedback{color:var(--theme-error);font-weight:700}dialog{max-inline-size:min(32rem,calc(100% - 2rem));color:var(--theme-text);background:var(--theme-surface);border:1px solid var(--theme-border);border-radius:var(--theme-radius);box-shadow:0 .5rem 1.5rem var(--theme-shadow)}dialog h2{font-family:var(--theme-font-display)}dialog form{display:flex;gap:.5rem;flex-wrap:wrap}@media(forced-colors:active){.devices li,section,dialog{border-color:CanvasText}}@media(prefers-reduced-motion:reduce){*{transition-duration:.01ms!important;animation-duration:.01ms!important}}
</style>
