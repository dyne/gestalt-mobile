...
const quiz = {
  questions: [{ id: 'mode', header: 'Mode', question: 'Which mode?', choices: [{ label: 'Fast', description: 'Optimize speed.' }, { label: 'Careful', description: 'Optimize verification.' }], allowCustom: true, isSecret: false }],
};
