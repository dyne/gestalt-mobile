    ...
    launch: () => ({
      ...
      rpc: {
        request: async (method: string, params: unknown) => {
          ...
          return method === 'skills/list' ? result : {};
        },
      },
    }),
  };
...
describe('CodexSkillCatalog', () => {
  ...
  it.each([
        ...
        data: [
          {
            ...
            errors: [],
            skills: [
              { name: 'Alpha', path: '/skills/a/SKILL.md', enabled: 'yes', description: 'A' },
            ],
          },
        ],
      },
    ...
    await expect(
      new CodexSkillCatalog('work', server.launch, 20).list('/workspace'),
      ...
      skills: [
        {
          ...
          enabled: true,
          description: 'A',
          interface: { displayName: 'Alpha CLI' },
        },
      ],
      errors: [],
    });
