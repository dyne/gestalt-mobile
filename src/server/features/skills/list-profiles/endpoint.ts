...
export type ListSkillProfilesDependencies = Pick<SkillProfileStore, 'listGlobalProfileNames' | 'readGlobalProfile'> & {
  profilePath(name: string): string;
};

export function registerListSkillProfiles(app: FastifyInstance, deps: ListSkillProfilesDependencies): void {
